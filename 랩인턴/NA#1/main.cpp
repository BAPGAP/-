...
struct Machar{
    ...
    cout << "radix: " << numeric_limits<DP>::radix
    << " (" << ibeta << ")" << endl;
    cout << "mantissa digits: " << numeric_limits<DP>::digits
    << " (" << it << ")" << endl;
    cout << "round style: " << numeric_limits<DP>::round_style
    << " (" << irnd << ") [our 5 == IEEE 1]" << endl;
    cout << "guard digits: " << "[not in numeric_limits]"
    << " (" << ngrd << ")" << endl;
    cout << "epsilon: " << numeric_limits<DP>::epsilon()
    << " (" << eps << ")" << endl;
    ...
    << " (" << iexp << ")" << endl;
    cout << "min exponent: " << numeric_limits<DP>::min_exponent
    << " (" << minexp << ")" << endl;
    cout << "max exponent: " << numeric_limits<DP>::max_exponent
    << " (" << maxexp << ")" << endl;
    cout << "minimum: " << numeric_limits<DP>::min()
    << " (" << xmin << ")" << endl;
    cout << "maximum: " << numeric_limits<DP>::max()
    << " (" << xmax << ")" << endl;
    }
};
